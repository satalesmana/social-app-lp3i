  ...
  return (
    <Modal animationType="fade" transparent={true} visible={visible} onRequestClose={onClose} statusBarTranslucent={true}>
      <Pressable onPress={onClose} className="flex-1 justify-center items-center bg-black/60 p-4">
        <Pressable onPress={(e) => e.stopPropagation()} className="bg-white rounded-2xl w-full max-w-3xl flex flex-col" style={{ minHeight: 400 }}>
      ...
      <>
        <View className="flex-row justify-center">
          <View className="w-1/5 h-screen p-4 flex flex-col">
            <View>
              <FontAwesome name="twitter" size={30} color="rgb(29, 155, 240)" className="mb-8 ml-2" />
              <Pressable onPress={() => router.push("/")} className="flex-row items-center mb-6">
                <Feather name="home" size={28} color="black" />
                <Text className="text-xl font-bold ml-4">Home</Text>
              </Pressable>
              <Pressable onPress={() => router.push("/message")} className="flex-row items-center mb-6">
                <Feather name="message-square" size={28} color="black" />
                <Text className="text-xl font-bold ml-4">Message</Text>
              </Pressable>
              <Pressable onPress={() => router.push("/account")} className="flex-row items-center mb-6">
                <Feather name="user" size={28} color="black" />
                <Text className="text-xl font-bold ml-4">Account</Text>
              </Pressable>
              <TouchableOpacity onPress={() => setDesktopModalVisible(true)} className="bg-sky-500 py-3 rounded-full mt-4">
