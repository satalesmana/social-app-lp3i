...
// 1. Tambahkan useWindowDimensions
import { View, Text, Image, ScrollView, ActivityIndicator, Pressable, RefreshControl, Modal, TextInput, Keyboard, SafeAreaView, useWindowDimensions } from "react-native";
...
export default function HomeScreen() {
  // 2. Tambahkan logika untuk mendeteksi layar desktop
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      {/* 3. Bungkus tombol dengan kondisi !isDesktop */}
      {!isDesktop && (
        <Pressable
          onPress={() => setModalVisible(true)}
          className="bg-blue-500 rounded-full w-14 h-14 justify-center items-center absolute bottom-5 right-5 shadow-lg"
        >
          <View>
